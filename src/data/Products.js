...
export const getPageData = (pageNumber, elemPerPageCount) => {
  console.log(pageNumber * elemPerPageCount + " " + (pageNumber + 1) * elemPerPageCount)
  console.log(products.slice(pageNumber * elemPerPageCount, (pageNumber + 1) * elemPerPageCount))
